   ...
   <header>
     <div class="container-fluid">
       <nav class="navbar navbar-expand-md navbar-dark bg-dark">
           ...
           <ul class="navbar-nav">
             <li class="nav-item"> <a href="user-login.php" class="nav-link"> Войти</a> </li>
       ...
       <div class="container">
         ...
         <div class="jumbotron">
           ...
           <p>Давайте создадим учетную запись, потому что она всегда бесплатна </p> <br>
           ...
           <form class="" action="user.php" method="POST">
             ...
             <div class="form-group col-md-8" >
               <label for="dob"> <br> Дата рождения </label>
               <div class="row">
                 <div class="col">
                 ...
                 <div class="signupbutton">
                   <br><br>
                   <button type="submit" style="background-color:#3500d3;color: white; class="btn btn-success btn-lg" name="sub" value="submit">Зарегистрироваться</button>
