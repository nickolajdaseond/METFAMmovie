              ...
              echo"<h1 style='color:white;position:sticky;'>WELCOME </h1><b style = 'color: white;font-size: 25px'><i> ".ucwords($rel['name'])." !</i></b>
                ...
                <div class='row'>
                  <div class='col'>
                    ...
                    <h4 style='color:black;font-size:30px;'>Недавний :
                    <input type='submit' name='submit' class='btn btn-success' style='display:inline;background-color:black;border:none;width:200px;margin-left:20px;margin-right:20px;' value='".ucwords($rel2['name'])."'/></h4>
                    </form>
                  </div>
                  <div class='col'>
                    <form action='search.php' method='POST'>
                      ...
                      <input type='submit' name='submit' class='btn btn-success' style='display:inline;background-color:black;border:none;width:100px;margin-left:20px;margin-right:20px;margin-top:5px;' value='Найти'/></h4>
                    </form>
                  </div>
                </div>
                </div>";
                  ?>
      <div class="jumbotron">
        <h2 style='margin-top:0px;padding-top:0px;'>Новинка</h2>
          <div class="row">
            <?php
