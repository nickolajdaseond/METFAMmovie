     ...
     <header>
         ...
         <nav class="navbar navbar-expand-md navbar-dark bg-dark">
             ...
             <ul class="navbar-nav">
               ...
               <li class="nav-item"> <a href="logout.php" class="nav-link">Выход из учетных записей</a> </li>
             </ul>
      ...
      echo"  <form  action='update.php' method='POST'>
          ...
          <input type='text' class='from-control' placeholder='Enter Date of Birth' name='dob' value='".$result['DOB']."'><br>
              ...
              <div  class='signupbutton'>
                <br><br>
                <button type='submit' class='btn btn-success' name='sub' value='submit'>Обновить информацию</button>
